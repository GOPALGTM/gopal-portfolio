...
export default function About() {
  return (
    <section id="about" className="max-w-5xl mx-auto px-4 sm:px-6 py-16 flex flex-col md:flex-row items-center gap-8 md:gap-12">
      {/* Image Section */}
      <div className="flex-shrink-0 w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64 rounded-3xl overflow-hidden border-4 border-cyan/80 shadow-neon">
        <img
          src={myPhoto}
          alt="My Photo"
      ...
      <div className="text-center md:text-left max-w-xl">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-cyan mb-4 drop-shadow-md">About Me</h2>
        <p className="text-white/80 mb-4 leading-relaxed font-sans text-base sm:text-lg">
        ...
        <p className="text-white/70 leading-relaxed font-mono text-sm sm:text-base">
